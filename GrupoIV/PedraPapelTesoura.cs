...
namespace GrupoIV
{
    public class PedraPapelTesoura
    {
        ...
        {
            Console.WriteLine("Como te chamas 1?");
            char nome1 = char.Parse(Console.ReadLine());
            Console.WriteLine("Como te chamas 2?");
            char nome2 = char.Parse(Console.ReadLine());
            Console.WriteLine("Quanta ronda?");
            int nrjogadas = int.Parse(Console.ReadLine());

            Display(nome1, nome2, nrjogadas);
        }
